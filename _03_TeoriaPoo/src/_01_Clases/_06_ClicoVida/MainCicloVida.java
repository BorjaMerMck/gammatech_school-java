package _01_Clases._06_ClicoVida;
...
public class MainCicloVida {
	public static void main(String[] args) {
		...
		/*
		 * Al instanciar objetos lo hacemos creando referencias.
		 * Esto es guardar el objeto en una variable.
		 * Se puede crear un objeto simplemente con la palabra new,
		 * sin necesidad de guardarlo en ningún lugar.
		 * Pero si queremos acceder a sus atributos, utilizar sus métodos
		 * o almacenar información, necesitamos poder acceder a ella.
		 */
		
		//Instancia de objeto con la palabra new
		new Persona();
		new Persona().edad = 45;
		...
		//Solamente pueden ser null las referencias
		Persona p2 = null;
		String s = null;
		Random rd = null;
