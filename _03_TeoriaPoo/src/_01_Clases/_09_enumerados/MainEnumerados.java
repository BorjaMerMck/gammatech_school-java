package _01_Clases._09_enumerados;
...
public class MainEnumerados {
	...
	public static void main(String[] args) {
		...
		d1.setTipoVia(TipoVia.values()[seleccion]);
		...
		//METODOS UTILIZADOS:
		System.out.println(Arrays.toString(TipoVia.values())); //array de todos los valores disponibles
		System.out.println(TipoVia.CARRETERA.ordinal()); //número de posición del valor introducido
		System.out.println(TipoVia.valueOf("PASEO"));
